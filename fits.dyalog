...
⍝ === VARIABLES ===
    ...
    help,←⊂''
    help,←⊂'fitspath←''/Users/s/papers/2020-06-01-thesis_healtree_chapter/S200302c.multiorder.fits'''
    help,←⊂'h←fits.headers fitspath'
    help,←⊂''
    help,←⊂'Display the first fits header (dropping the history and comment columns), which'
    help,←⊂'should always look like this:'
    help,←⊂''
    help,←⊂')copy util DISP'
    help,←⊂'DISP ⍪¨¯2↓h[0;]'
    help,←⊂''
    ...
    help,←⊂'└────┴────────┴──────────────────────────┴─┴─┴───┴─┴─┘'
    help,←⊂''
    help,←⊂'View the raw shapes of the data associated with each header in the file (in'
    help,←⊂'bytes):'
    help,←⊂''
    ...
    help,←⊂'└∊───────────────┘'
    help,←⊂''
    help,←⊂'View the metadata fields on the second header, which defines the actual image:'
    help,←⊂''
    help,←⊂'h[1;1 2]'
    help,←⊂''
